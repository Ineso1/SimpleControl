...
void Luenberger::InitializeEstimates() {
    ...
    //      4.40646889634985e-09,    2.73968158380886e-10,   680.400000000558;
        ...
        L_trans <<  11.0000,   -0.0000,   -0.0000,
                    0.0000,   11.0000,    0.0000,
                -0.0000,    0.0000,   11.0000,
                41.0000,   -0.0000,    0.0000,
                    0.0000,   41.0000,    0.0000,
                -0.0000,    0.0000,   41.0000,
                    0.1280,    0.0039,   -0.0001,
                    0.0039,    0.1282,    0.0000,
                -0.0001,    0.0000,    0.2481,
                    0.0629,    0.0019,   -0.0001,
                    0.0019,    0.0631,    0.0000,
                -0.0001,    0.0000,    0.1220;
...
flair::core::Vector3Df Luenberger::EstimateDisturbance_trans(const flair::core::Vector3Df& p_aux, const flair::core::Vector3Df& dp_aux, const flair::core::Vector3Df& u_thrust_aux, float dt) {
    ...
    Eigen::VectorXf dx_hat_ext_L_trans = 
        A_ext_trans * x_trans + 
        B_ext_trans * (u_thrust + Eigen::Vector3f(0, 0, g * mass)/10) + 
    ...
    w_hat_trans = disturbance_estimate;
    return flair::core::Vector3Df(w_hat_trans.x(),w_hat_trans.y(),w_hat_trans.z());
}


flair::core::Vector3Df Luenberger::EstimateDisturbance_rot(const flair::core::Quaternion& q_aux, const flair::core::Vector3Df& omega_aux, const flair::core::Vector3Df& u_torque_aux, float dt) {
